...
/**
 * Unit tests for Client model (Lab 3)
 */
class ClientTest {
    @Test
    void testConstructor() {
        Client client = new Client("John", "Doe", "john@example.com", "+1234567890", 1);
    ...
    @Test
    void testEquals() {
        Client client1 = new Client("John", "Doe", "john@example.com", "+123", 1);
        client1.setId(1);
        Client client2 = new Client("John", "Doe", "john@example.com", "+123", 1);
        client2.setId(1);
        Client client3 = new Client("Jane", "Smith", "jane@example.com", "+456", 2);
        client3.setId(2);
